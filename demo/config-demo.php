...
# head and title of window
$config['title'] = 'Modern Contact Form v1.0';
$config['head'] = 'Contact Us';

# theme: green yellowblue blue pink dark
$config['theme'] = ( (isset($_GET['theme'])&&in_array($_GET['theme'], explode(' ','green yellowblue blue pink dark'))) ?$_GET['theme']:'yellowblue');
...
$config['inputs'][] = array(
	'type'=>'checkbox',
	'placeholder'=>'Reason : &nbsp;',
	'checkboxes'=>array('Support','Suggestion','Other'),
	'name'=>'Checked'
);
...
$config['notifications'] = array( # you can use one or multiple notification methods simultaneously
	'notify1' => array( # send to email (note: to make this work you need to put the script in a public server)
		'type' => 'email',
		'config' => array(
